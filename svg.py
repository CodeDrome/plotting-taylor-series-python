...
class SVG(object):
    ...
    def __generate_templates(self):
        ...
        templates["text"] = "    <text x='{}' y = '{}' font-family='{}' stroke='{}' fill='{}' font-size='{}px' text-anchor='{}'>{}</text>\n"
    ...
    def text(self, x, y, fontfamily, fontsize, fill, stroke, textanchor, text):

        """
        Adds text using the method's arguments.
        """

        self.__add_to_svg(self.templates["text"].format(x, y, fontfamily, stroke, fill, fontsize, textanchor, text))
